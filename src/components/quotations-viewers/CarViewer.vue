  ...
  <v-container>
    ...
    <v-row class="mt-1 mb-3">
      ...
      <v-col cols="12" sm="6">
        ...
        <v-text-field v-model="quotation.carData.model" readonly></v-text-field>
      </v-col>
      <v-col cols="12" sm="6">
        <v-label>Año</v-label>
        <v-text-field v-model="quotation.carData.year" readonly></v-text-field>
      </v-col>
      <v-col cols="12" sm="6">
