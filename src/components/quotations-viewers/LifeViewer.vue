  ...
  <v-container>
    ...
    <v-row class="mt-1 mb-3">
      ...
      <v-col cols="12" md="6">
        ...
        <v-select v-model="quotation.lifeData.smoker" readonly></v-select>
      </v-col>
      <v-col cols="12" md="6">
        <v-label>¿Tienes alguna modalidad en mente?</v-label>
        <v-text-field v-model="quotation.lifeData.modality" readonly></v-text-field>
      </v-col>
      <v-col cols="12" md="6">
        <v-label>¿Tienes alguna suma asegurada en mente?</v-label>
        <v-text-field v-model="quotation.lifeData.insuredSum" readonly></v-text-field>
      </v-col>
    </v-row>
